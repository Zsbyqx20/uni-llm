...
from uni_llm.anthropic import AnthropicClient, process_content_block_default
from uni_llm.base import BaseMessage, Role, ServiceType
from uni_llm.message import ImageMessage, TextMessage
...
class TestAnthropicClient:
    ...
    def test_init_client_extended(self, mocker):
        mock_anthropic = mocker.patch("uni_llm.anthropic.Anthropic")
        mock_async_anthropic = mocker.patch("uni_llm.anthropic.AsyncAnthropic")
    ...
    def test_create_anthropic_content_image(self, client, sample_image, mocker):
        mocker.patch(
            "uni_llm.message.ImageMessage.content",
